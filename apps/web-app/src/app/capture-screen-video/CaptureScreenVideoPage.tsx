export function CaptureScreenVideoPage() {
  return <section className="grid">
    <div className="hero"><span className="pill">Private beta recorder</span><h1>Capture Screen Video</h1><p className="muted">Record your browser, screen, or app window, then upload it to VideoBlitzer for clips, exports, and MP4 conversion.</p><div className="tabs"><a className="button" href="/download">Download Mac Recorder</a><a className="button secondary" href="/download">Download Windows Recorder</a><a className="button secondary" href="/manual">How to record browser video</a></div></div>
