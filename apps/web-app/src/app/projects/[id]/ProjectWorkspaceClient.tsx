...
type PackageJob = { id?: string; status?: string; stage?: string; progress?: number; error_message?: string; artifact_object_key?: string; package_variant?: string; input?: Record<string, unknown>; output?: Record<string, unknown>; manifest_json?: Record<string, unknown>; created_at?: string; completed_at?: string | null };
